# Credit: 2021 Pieter Wuille
# Original file: https://github.com/bitcoin/bitcoin/blob/master/test/functional/test_framework/ripemd160.py
# Below is a slightly shorter version of the original file
